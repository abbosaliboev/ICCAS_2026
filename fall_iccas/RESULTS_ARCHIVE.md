# Training Results — Archive / 학습 결과 아카이브

> **Full run history (Runs 1–15).** The current/latest results live in **RESULTS.md**; this file is the complete record kept for a future paper.
