...
def main():
    ...
    ap.add_argument("--stage1-threshold", type=float, default=None, help="ST-GCN confident FALL threshold (default: from config)")
    ap.add_argument("--rescue-threshold", type=float, default=None, help="Physics rescue lower probability threshold (default: from config)")
